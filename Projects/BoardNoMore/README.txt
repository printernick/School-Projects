...
Hovering over the image will enlarge the picture. Clicking the image will redirect
the user to a more detailed page.
...
REQUIREMENTS:
1. Satisfied on Home page
2. Satisfied on Board Games page
3. Satisfied on Board Games page
4. Satisfied on Board Games page
5. Satisfied on Board Games page
6. Satisfied on detailed pages (after clicking a product)
7. Satisfied on detailed pages (after clicking a product) after clicking submit
8. Satisfied on detailed pages (after clicking a product) after clicking submit
9. Satisfied throughout website (styles.css)
10. Satisfied on Board Games page (hovering over an image)
11. Satisfied on Home page
